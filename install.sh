...
display_welcome() {
  ...
  echo -e "${WHITE}[+]                  © AroellOfficial                [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e ""
  ...
  echo -e ""
  echo -e "𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 :"
  echo -e "@AroellOfficial1"
  echo -e "𝗖𝗥𝗘𝗗𝗜𝗧𝗦 :"
  echo -e "@AroellOfficial"
  sleep 4
  clear
}
...
check_token() {
  ...
  if [ "$USER_TOKEN" = "aroell" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke AroellDev${NC}"
    echo -e "${YELLOW}TELEGRAM : @AroellOfficial1${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283892737429${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©AroellOfficialDev${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${WHITE}ggg:     gg.     -   ,ggg       • WhatsApp : 6283892737429    ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : AroellOfficial ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by AroellOfficial Bot  ${NC}"
